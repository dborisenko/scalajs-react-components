...
case object DomInput extends DomType("FromInput") {
  ...
  private val formMethodType =
    com.dbrsn.generator.Enum(CompName("Input"), Seq("get", "post"), "FormMethodType")
  private val formTarget =
    com.dbrsn.generator.Enum(CompName("Input"), Seq("_blank", "_self", "_parent", "_top", "framename"), "FormTarget")
  private val inputAutoComplete =
    com.dbrsn.generator.Enum(CompName("Input"), Seq("on", "off"), "AutoComplete")
  private val inputType = com.dbrsn.generator.Enum(
    CompName("Input"),
    Seq(
      "button",
      "checkbox",
  ...
  private val inputEncodingType = com.dbrsn.generator.Enum(
    CompName("Input"),
  ...
  override val props: Seq[ParsedProp] = super.props ++
    Seq(
      ParsedProp(
        ...
        commentOpt = Some(PropComment("Specifies the types of files that the server accepts (only for type='file')"))
      ),
      ParsedProp(
        PropName("alt"),
        baseType = Normal("String"),
        commentOpt = Some(PropComment("Specifies an alternate text for images (only for type='image')"))
      ),
      ParsedProp(
        PropName("autocomplete"),
        baseType = inputAutoComplete,
        commentOpt = Some(PropComment("Specifies whether an <input> element should have autocomplete enabled"))
      ),
      ParsedProp(
        PropName("autofocus"),
        baseType = Normal("Boolean"),
        commentOpt =
          Some(PropComment("Specifies that an <input> element should automatically get focus when the page loads"))
      ),
      ParsedProp(
        PropName("checked"),
        baseType = Normal("Boolean"),
      ...
      ParsedProp(
        PropName("dirname"),
        baseType = Normal("Boolean"),
        commentOpt = Some(PropComment("Specifies that the text direction will be submitted"))
      ),
      ParsedProp(
        PropName("disabled"),
        baseType = Normal("Boolean"),
        commentOpt = Some(PropComment("Specifies that an <input> element should be disabled"))
      ),
      ParsedProp(
        PropName("form"),
        baseType = Normal("String"),
        commentOpt = Some(PropComment("Specifies one or more forms the <input> element belongs to"))
      ),
      ParsedProp(
        PropName("formaction"),
        baseType = Normal("String"),
      ...
      ParsedProp(
        ...
        commentOpt = Some(
          PropComment("Defines the HTTP method for sending data to the action URL (for type='submit' and type='image')")
        )
      ),
      ParsedProp(
        PropName("formnovalidate"),
        baseType = Normal("Boolean"),
        commentOpt = Some(PropComment("Defines that form elements should not be validated when submitted"))
      ),
      ParsedProp(
        PropName("formtarget"),
        baseType = formTarget,
      ...
      ParsedProp(
        PropName("height"),
        baseType = Normal("Int"),
        commentOpt = Some(PropComment("Specifies the height of an <input> element (only for type='image')"))
      ),
      ParsedProp(
        PropName("list"),
        baseType = Normal("String"),
        commentOpt =
          Some(PropComment("Refers to a <datalist> element that contains pre-defined options for an <input> element"))
      ),
      ParsedProp(
        PropName("max"),
        baseType = Normal("Long | String"),
        commentOpt = Some(PropComment("Specifies the maximum value for an <input> element"))
      ),
      ParsedProp(
        PropName("maxlength"),
        baseType = Normal("Int"),
        commentOpt = Some(PropComment("Specifies the maximum number of characters allowed in an <input> element"))
      ),
      ParsedProp(
        PropName("min"),
        baseType = Normal("Long | String"),
      ...
      ParsedProp(
        PropName("multiple"),
        baseType = Normal("Boolean"),
        commentOpt = Some(PropComment("Specifies that a user can enter more than one value in an <input> element"))
      ),
      ParsedProp(
        PropName("name"),
        baseType = Normal("String"),
      ...
      ParsedProp(
        ...
        baseType = Normal("String"),
        commentOpt =
          Some(PropComment("Specifies a regular expression that an <input> element's value is checked against"))
      ),
      ParsedProp(
        PropName("placeholder"),
        baseType = Normal("String"),
        commentOpt = Some(PropComment("Specifies a short hint that describes the expected value of an <input> element"))
      ),
      ParsedProp(
        PropName("readonly"),
        baseType = Normal("Boolean"),
      ...
      ParsedProp(
        PropName("required"),
        baseType = Normal("Boolean"),
        commentOpt = Some(PropComment("Specifies that an input field must be filled out before submitting the form"))
      ),
      ParsedProp(
        PropName("size"),
        baseType = Normal("Int"),
        commentOpt = Some(PropComment("Specifies the width; in characters; of an <input> element"))
      ),
      ParsedProp(
        PropName("src"),
        baseType = Normal("String"),
        commentOpt =
          Some(PropComment("Specifies the URL of the image to use as a submit button (only for type='image')"))
      ),
      ParsedProp(
        PropName("step"),
        baseType = Normal("Int"),
        commentOpt = Some(PropComment("Specifies the legal number intervals for an input field"))
      ),
      ParsedProp(
        PropName("type"),
        baseType = inputType,
      ...
      ParsedProp(
        PropName("width"),
        baseType = Normal("Int"),
        commentOpt = Some(PropComment("Specifies the width of an <input> element (only for type='image')"))
      )
    )
}
