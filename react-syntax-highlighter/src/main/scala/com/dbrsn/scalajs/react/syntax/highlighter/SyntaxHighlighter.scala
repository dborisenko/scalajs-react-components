...
final case class SyntaxHighlighter(
  /**
    * language - the language to highlight code in. (pass text to just render plain monospaced text).
    */
  language: HljsLanguage,
  /**
    * style - style object required from styles/hljs directory depending on whether or not you are
    * importing from react-syntax-highlighter . Will use default if style is not included.
    */
  style: UndefOr[HljsStyle] = undefined,
  /**
  ...
  def apply(children: VdomNode*): UnmountedWithRawType[js.Object, Null, RawMounted[js.Object, Null]] = {
    ...
    val props = JSMacro[SyntaxHighlighter](this)
    val f = JsComponent[js.Object, Children.Varargs, Null](RawSyntaxHighlighter)
    f(props)(children: _*)
  }
}
